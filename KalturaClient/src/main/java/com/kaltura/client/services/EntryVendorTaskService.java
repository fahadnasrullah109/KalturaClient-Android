...
public class EntryVendorTaskService {
	...
	public static class ApproveEntryVendorTaskBuilder extends NullRequestBuilder {
		
		public ApproveEntryVendorTaskBuilder(int id) {
			super("reach_entryvendortask", "approve");
			params.add("id", id);
		}
	...
	public static class RejectEntryVendorTaskBuilder extends NullRequestBuilder {
		
		public RejectEntryVendorTaskBuilder(int id, String rejectReason) {
			super("reach_entryvendortask", "reject");
			params.add("id", id);
	...
	public static class UpdateEntryVendorTaskBuilder extends NullRequestBuilder {
		
		public UpdateEntryVendorTaskBuilder(int id, EntryVendorTask entryVendorTask) {
			super("reach_entryvendortask", "update");
			params.add("id", id);
			params.add("entryVendorTask", entryVendorTask);
		}
